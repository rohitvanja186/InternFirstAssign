        ...
        <form className="space-y-4" action="#">
          ...
          <div className="flex items-start">
            <div className="flex items-center h-5">
              <input id="terms" type="checkbox" className="w-4 h-4 border border-gray-300 rounded bg-white focus:ring-3 focus:ring-green-300" required />
            </div>
            <div className="ml-3 text-sm">
              <label htmlFor="terms" className="text-gray-600">I accept the <a className="font-medium text-green-600 hover:underline" href="#">Terms and Conditions</a></label>
            </div>
          </div>
          ...
          <p className="text-sm font-light text-gray-600">
            Already have an account? <Link to="/" className="font-medium text-green-600 hover:underline">Login here</Link>
          </p>
        </form>
      </div>
    </section>
